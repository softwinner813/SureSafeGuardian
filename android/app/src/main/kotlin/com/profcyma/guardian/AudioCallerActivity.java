...
import com.profcyma.guardian.models.CallAcceptedEvent;
import com.profcyma.guardian.models.db.database.SaberDatabase;
import com.profcyma.guardian.models.db.entities.Call;
...
public class AudioCallerActivity extends AppCompatActivity {
        ...
        @BindView(R.id.calling_user_text)
        TextView callingUserTextView;

        @BindView(R.id.calling_user_ended_text)
        ...
        @BindView(R.id.contact_phone_display)
